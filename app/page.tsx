  ...
  return (
    ...
    >
      ...
      <nav className="fixed top-0 left-0 w-full z-50 border-b border-black/10 bg-white/90 backdrop-blur dark:border-white/10 dark:bg-black/80">
        <div className="px-8 md:px-16 py-6 flex items-center justify-center">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-sm tracking-tight">
      ...
      <section className="py-32 px-8 md:px-16 space-y-32 scroll-smooth scroll-snap-type-y-mandatory">
        {SECTIONS.map((section, index) => (
          <motion.div
            ...
            className={section.id === "filmmaking" || section.id === "articles" ? "min-h-screen flex flex-col justify-center border-t border-black/10 dark:border-white/10 pt-16 scroll-snap-align-start" : "grid grid-cols-1 md:grid-cols-2 gap-16 items-start border-t border-black/10 dark:border-white/10 pt-16"}
          >
